...
import { BullsharkExpression, type BullsharkSkin } from "../../types.js";
...
export function LeftArmPattern({
  ...
  const transform = useAnimatedPartTransform("leftArm", baseTransform);

  return (
    <g transform={transform}>
      <g transform={expression === "ourah" ? "rotate(45)" : "rotate(0)"}>
        {expression === "ourah" && (
          <animateTransform
