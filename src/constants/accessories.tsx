...
export const accessories: AccessoryMetadata[] = [
  ...
  },
  {
    type: "torso",
    category: "team",
    renderOptions: { country: "US", side: "home" },
    name: "soccer team shirt",
    price: 2000000000,
    quantity: null,
    description: "Country soccer shirt from the team collection",
    collection: "soccer",
  },
  {
    type: "legs",
    category: "team",
    renderOptions: { country: "US", side: "home" },
    name: "soccer team swim trunks",
    price: 2000000000,
    quantity: null,
    description: "Country soccer swim trunks from the team collection",
    collection: "soccer",
  },
  {
    type: "legs",
  ...
  },
  {
    type: "feet",
    category: "shoes",
    renderOptions: { animationPart: "leftLeg" },
    name: "left goth boot",
    price: 2000000000,
    quantity: null,
    description: "",
  ...
  },
  {
    type: "feet",
    category: "shoes",
    renderOptions: { animationPart: "rightLeg" },
    name: "right goth boot",
    price: 2000000000,
    quantity: null,
    description: "",
    collection: "",
